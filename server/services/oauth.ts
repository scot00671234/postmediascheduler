...
export class OAuthService {
  ...
  private initializeConfigs() {
    ...
    this.configs.set("instagram", {
      ...
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/instagram`,
    ...
    this.configs.set("facebook", {
      ...
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/facebook`,
    ...
    this.configs.set("tiktok", {
      ...
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/tiktok`,
    ...
    this.configs.set("youtube", {
      ...
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/youtube`,
      scopes: ["https://www.googleapis.com/auth/youtube.upload"],
      authUrl: "https://accounts.google.com/o/oauth2/v2/auth",
      tokenUrl: "https://oauth2.googleapis.com/token",
    });

    // Bluesky configuration (uses different auth flow)
    this.configs.set("bluesky", {
      clientId: process.env.BLUESKY_CLIENT_ID || "",
      clientSecret: process.env.BLUESKY_CLIENT_SECRET || "",
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/bluesky`,
      scopes: ["atproto"],
    ...
    this.configs.set("threads", {
      clientId: process.env.THREADS_CLIENT_ID || "",
      clientSecret: process.env.THREADS_CLIENT_SECRET || "",
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/threads`,
    ...
    this.configs.set("pinterest", {
      ...
      redirectUri: `${this.getBaseUrl()}/api/oauth/callback/pinterest`,
